...
(async () => {
  ...
  try {
    ...
    const fixture = {...live, records, connections:{...live.connections, 'instagram-xavier':{...live.connections['instagram-xavier'], active:true, configured:true, connectedAt:new Date().toISOString()}}};
    ...
    for (const width of [390,768,1440]) {
      ...
      for (const hash of ['#social','#social/instagram-xavier','#social/spotify-xavier','#accounts']) {
