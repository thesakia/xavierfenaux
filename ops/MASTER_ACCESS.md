...
Nginx auth_request checks the master session before proxying Clips and IVT Radar.
Back-end Basic Auth credentials stay server-side.
...
The Clips provider webhooks keep their original validation.
...
- Browser: login once, visit Clips/IVT Radar, restore browser state, verify
